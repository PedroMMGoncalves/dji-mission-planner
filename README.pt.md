...
**Estado dos perfis:** todos os perfis de câmara (M3E, M4T grande-angular e térmica, P1) e o Mapper+ usam valores publicados nas fichas técnicas. A grande-angular do M4T (1/1.3" 48 MP, 24 mm eq., focal real 6,7 mm) e a térmica (VOx 640×512, 12 µm, DFOV 45°) vêm da ficha técnica da série Matrice 4 da DJI; o GSD térmico é calculado sobre o detector físico e não sobre o R-JPEG 1280×1024 de super-resolução. Confirmar as focais contra o EXIF de fotografias originais faz parte da validação de campo.
