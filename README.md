...
**Profile status:** all camera profiles (M3E, M4T wide and thermal, P1) and the Mapper+ use published spec-sheet values. The M4T wide camera (1/1.3" 48 MP, 24 mm eq., 6.7 mm real focal) and thermal camera (640×512 VOx, 12 µm, DFOV 45°) come from the DJI Matrice 4 series spec sheet; the thermal GSD is computed on the physical detector, not on the 1280×1024 super-resolution R-JPEG. Confirming the focal lengths against the EXIF of original photos is part of the field validation.
